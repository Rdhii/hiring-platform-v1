export default function JobItem(job) {
  return (
    <div className='border ml-26 rounded-lg border-[#01777F] bg-[#146166]/10 w-[384px]'>
        <div className='px-4 py-3 flex gap-4 items-center'>
            <img className='size-12 border-gray-300 border rounded-sm' src='../../../public/63_human_verify.jpg' />
            <div>
